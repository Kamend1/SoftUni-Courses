...
print(t.add_team('IndoorTeam', 'Levski', 'BG', 250))
print(t.add_team('IndoorTeam', 'Spartak', 'BG', 250))
print(t.add_team('IndoorTeam', 'Dobrich', 'BG', 280))

print(t.sell_equipment('KneePad', 'Spartak'))
print(t.sell_equipment('ElbowPad', 'Spartak'))
print(t.sell_equipment('ElbowPad', 'Spartak'))
print(t.sell_equipment('ElbowPad', 'Spartak'))

print(t.remove_team('Levski'))
print(t.add_team('IndoorTeam', 'Lokomotiv', 'BG', 250))
