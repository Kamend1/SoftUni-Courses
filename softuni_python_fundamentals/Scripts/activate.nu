...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kamen.dimitrov\PycharmProjects\python_fundamentals\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kamen.dimitrov\PycharmProjects\python_fundamentals\venv\Scripts\deactivate.nu'
