...
from main_app.models import Customer, DiscountedProduct, Product
...
# product = Product.objects.filter(name="Gaming Keyboard").first()
#
...
# discounted_product = DiscountedProduct.objects.filter(name="Gaming Mouse").first()
#
