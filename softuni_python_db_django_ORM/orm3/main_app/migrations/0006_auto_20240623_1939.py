# Generated by Django 5.0.4 on 2024-06-23 16:39
import random
...
class Migration(migrations.Migration):
    ...
    def revert_barcodes(apps, schema_editor):
        Product = apps.get_model("main_app", 'Product')
    ...
    operations = [
        migrations.RunPython(generate_barcodes, reverse_code=revert_barcodes)
    ]
